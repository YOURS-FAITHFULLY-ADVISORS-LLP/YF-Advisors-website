  ...
  return (
    <ArticleWrapper>
      ...
      <div className="hero-section">
        ...
        {/* Make sure the image is saved at public/blog/optimism.jpg */}
        <Image 
          src="/blog/optimism.jpg" 
          alt="Optimism and Self Belief" 
          fill 
          priority 
          className="hero-img" 
        />
        <div className="hero-content">
          ...
          <h1 className="article-title">Optimism and Self Belief</h1>
      ...
      <div className="container">
        ...
        <div className="content-grid">
          ...
          <div className="article-body">
            <h2 className="section-heading">Navigating Uncertainty</h2>
            <p className="intro-text">
              We are living in a world of Knightian uncertainty in the absence of determinate knowledge about the next mutation of COVID-19.
            </p>
            ...
            <div className="quote-box">
              <p>
                If the last two years of living with the virus have taught us anything, it is to remain humble, but grounded in self-belief, never losing confidence and optimism.
              </p>
            </div>

            <p>
              At YF Advisors, we believe that maintaining this optimism is essential for business resilience. Adapting to change with confidence allows organizations to overcome unpredictable challenges and emerge stronger.
            </p>

            <div className="cta-box">
              <h3>Build Resilience with Us</h3>
              <p>Partner with YF Advisors to navigate economic uncertainty with confidence.</p>
          ...
          <aside className="sidebar">
            <div className="sidebar-widget">
              <h4>Read Next</h4>
              <ul>
                <li><Link href="/blog/happy-new-year-2022">Happy New Year 2022</Link></li>
