...
export default function NewYear2022Page() {
  return (
    <ArticleWrapper>
      {/* Hero Section */}
      <div className="hero-section">
        ...
        <div className="hero-content">
          ...
          <h1 className="article-title">Wish You a Happy New Year 2022</h1>
          <div className="meta-data">October 7, 2022 • By YF Advisors</div>
        </div>
      </div>
        ...
        <div className="content-grid">
          ...
          <div className="article-body">
            ...
            <div className="greeting-card">
              <h2 className="greeting-title">Season&apos;s Greetings from YF Advisors</h2>
              <p className="intro-text">
                As we embark on another year, we take this moment to extend our heartfelt gratitude for your continued trust and partnership.
              </p>
              
              <div className="highlight-box">
                <p className="highlight-text">
                  We wish you and your family a Happy New Year 2022. May this year bring prosperity, health, and new opportunities.
                </p>
              </div>

              <p>
                At <strong>Yours Faithfully Advisors LLP</strong>, we are committed to supporting your growth through our dedicated Consulting & Outsourcing services. We look forward to achieving new milestones together in the coming year.
              </p>
              
              <div className="image-preview">
                <Image 
                  src="/blog/new-year-2022.jpg" 
                  alt="New Year Greeting Card"
                  width={600}
                  height={800}
              ...
              <div className="sign-off">
                <p>Warm Regards,</p>
                <p><strong>The Team at Yours Faithfully Advisors</strong></p>
                <Link href="/" className="website-link">www.yfadvisors.in</Link>
              </div>
            </div>

            {/* CTA Box */}
            <div className="cta-box">
              <h3>Start the Year Strong</h3>
              <p>Let&apos;s discuss how we can optimize your business operations this year.</p>
...
const ArticleWrapper = styled.article`
  ...
  .greeting-title { color: #002B49; font-size: 1.8rem; margin-bottom: 20px; font-weight: 800; text-align: center; }
  .intro-text { text-align: center; margin-bottom: 30px; font-size: 1.1rem; }
  ...
  .highlight-text { font-size: 1.2rem; font-weight: 600; margin: 0; }

  .image-preview { text-align: center; margin: 40px 0; }
  .content-image { max-width: 100%; height: auto; border-radius: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); }

  .sign-off { text-align: center; margin-top: 40px; padding-top: 20px; border-top: 1px solid #f1f5f9; }
  .website-link { color: #00A79D; font-weight: 700; text-decoration: none; display: block; margin-top: 5px; }
