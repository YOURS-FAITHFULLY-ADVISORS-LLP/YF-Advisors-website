    ...
    <footer className="w-full bg-slate-50 pt-16 pb-8 font-sans border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <h3 className="text-sm font-semibold text-slate-900 uppercase tracking-wider mb-6">Company</h3>
            <ul className="space-y-4">
              {['About Us', 'Our Team', 'Careers', 'Contact'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-slate-600 text-sm hover:text-[#00A79D] transition-colors duration-200">
                    {item}
                  </a>
                </li>
              ))}
